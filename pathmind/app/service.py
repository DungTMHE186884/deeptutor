...
from pathmind.services.session.protocol import ActiveTurnConflict, SessionStoreProtocol
...
class TurnApplicationService:
    ...
    async def start_turn(
        ...
        from pathmind.services.workspace.context import get_workspace_scope, workspace_context
