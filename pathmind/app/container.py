...
from pathmind.runtime.capability_catalog import get_capability_catalog
from pathmind.runtime.coordination import (
...
from pathmind.runtime.registry.capability_registry import CapabilityRegistry
from pathmind.runtime.turn_engine import TurnEngine
from pathmind.services.config import load_integrations_settings, load_system_settings
...
from pathmind.services.session.scope import store_scope
from pathmind.services.session.turn_runtime import TurnRuntimeManager
...
class ApplicationContainer:
    ...
    def _local_users() -> list[Any]:
        ...
        from pathmind.multi_user.paths import local_admin_user, scope_for_user
    ...
    async def migrate_legacy_chat(self, *, dry_run: bool = False) -> dict[str, Any]:
        ...
        from pathmind.services.session.legacy_migration import (
    ...
    async def migrate_all_workspace_preferences(self) -> list[dict[str, Any]]:
        ...
        from pathmind.multi_user.identity import list_user_info
        from pathmind.multi_user.models import CurrentUser
        from pathmind.multi_user.paths import local_admin_user, scope_for_user, user_context
    ...
    async def run_startup_data_migrations(self) -> dict[str, list[dict[str, Any]]]:
        ...
        from pathmind.multi_user.paths import user_context
        from pathmind.services.workspace.session_move import migrate_legacy_bindings
