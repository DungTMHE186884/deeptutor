...
class PathMindError(Exception):
    """Base class for all application errors in PathMind."""
...
class ConfigurationError(PathMindError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(PathMindError):
    """Raised when input validation fails."""

    pass


class ServiceError(PathMindError):
