...
contributed by
:class:`~pathmind.capabilities.course_study.capability.CourseStudyLoopCapability`.
...
from pathmind.capabilities.course_study.capability import (
    COURSE_STUDY_NAME,
    CourseStudyLoopCapability,
    resolve_course_id,
)
from pathmind.capabilities.course_study.tools import (
