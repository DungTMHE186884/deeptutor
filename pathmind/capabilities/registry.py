...
from pathmind.capabilities.protocol import LoopExtension
from pathmind.core.context import UnifiedContext
from pathmind.core.entry_points import load_entry_point_group
from pathmind.runtime.capability_catalog import EmptyConfig, get_capability_catalog

logger = logging.getLogger(__name__)

EXTENSIONS_GROUP = "pathmind.extensions"
LOOP_CAPABILITIES_GROUP = "pathmind.loop_capabilities"
...
BUILTIN_LOOP_CAPABILITY_SPECS: tuple[LoopCapabilitySpec, ...] = (
    LoopCapabilitySpec(
        "ask_questions",
        "pathmind.capabilities.ask_questions.loop:AskQuestionsLoopCapability",
    ),
    LoopCapabilitySpec("mastery", "pathmind.capabilities.mastery.loop:MasteryLoopCapability"),
    LoopCapabilitySpec("solve", "pathmind.capabilities.solve.loop:SolveLoopCapability"),
    LoopCapabilitySpec("obsidian", "pathmind.capabilities.obsidian.capability:ObsidianCapability"),
    LoopCapabilitySpec(
        "marginnote4",
        "pathmind.capabilities.marginnote4.capability:MarginNoteCapability",
    ),
    LoopCapabilitySpec("ima", "pathmind.capabilities.ima.capability:ImaCapability"),
    LoopCapabilitySpec(
        "immersive_reading",
        "pathmind.capabilities.reading.capability:ReadingCapability",
    ),
    LoopCapabilitySpec(
        "course_study",
        "pathmind.capabilities.course_study.capability:CourseStudyLoopCapability",
    ),
    LoopCapabilitySpec(
        "immersive_watching",
        "pathmind.capabilities.watching.capability:WatchingCapability",
    ),
    LoopCapabilitySpec(
        "explore_context",
        "pathmind.capabilities.explore_context.capability:ExploreContextCapability",
    ),
    LoopCapabilitySpec("setup", "pathmind.capabilities.setup.capability:SetupCapability"),
    LoopCapabilitySpec(
        "partner_authoring",
        "pathmind.capabilities.partner_authoring.capability:PartnerAuthoringCapability",
    ),
    LoopCapabilitySpec(
        "partner_group",
        "pathmind.capabilities.partner_group.capability:PartnerGroupCapability",
    ),
    LoopCapabilitySpec(
        "visualization_generation",
        "pathmind.visualizers.loop_capability:VisualizationLoopCapability",
    ),
)
