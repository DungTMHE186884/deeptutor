"""Setup loop capability — PathMind configuring its own install.

A *plain* :class:`~pathmind.capabilities.protocol.LoopExtension`, not a
:class:`~pathmind.capabilities.protocol.KnowledgeCapability`: configuring the
...
Activation is decided by :func:`~pathmind.capabilities.setup.binding.is_setup_turn`
...
from pathmind.capabilities.protocol import PromptBlock
from pathmind.capabilities.setup.binding import (
...
from pathmind.capabilities.setup.tools import SETUP_TOOL_NAMES
...
class SetupCapability:
    """Turn-scoped ability to inspect and change PathMind's own configuration."""
