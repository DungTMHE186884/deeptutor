# Configuring PathMind

You can read and change this PathMind install's own configuration. Your normal
...
- `restart` — the value only takes hold when PathMind restarts. Say so plainly.
