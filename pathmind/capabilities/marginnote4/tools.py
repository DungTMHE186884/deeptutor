...
(via :class:`~pathmind.capabilities.marginnote4.capability.MarginNoteCapability`,
...
:class:`~pathmind.capabilities.marginnote4.store.MarginNoteStore` methods.
...
from pathmind.capabilities.marginnote4.models import ALL_TYPES
from pathmind.capabilities.marginnote4.store import MarginNoteStore
