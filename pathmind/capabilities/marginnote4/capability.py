...
library (resolved by :mod:`pathmind.capabilities.marginnote4.binding`). As a
...
from pathmind.capabilities.marginnote4.binding import (
    marginnote_binding,
    marginnote_kb_refs,
)
from pathmind.capabilities.marginnote4.tools import MARGINNOTE_TOOL_NAMES
