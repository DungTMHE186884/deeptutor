...
from pathmind.knowledge.kb_types import IMA_KB_TYPE
...
def resolve_client(kb_ref: str, *, for_write: bool = False):
    ...
    from pathmind.services.rag.pipelines.ima.client import ImaClient
    from pathmind.services.rag.pipelines.ima.config import resolve_kb_config
    from pathmind.services.rag.provider_binding import load_kb_config_entry
