...
IMA library (resolved by :mod:`pathmind.capabilities.ima.binding`).

Unlike the Obsidian and subagent capabilities this is a *plain*
:class:`~pathmind.capabilities.protocol.LoopExtension`, not a
:class:`~pathmind.capabilities.protocol.KnowledgeCapability`: it **adds** its
...
from pathmind.capabilities.ima.binding import ima_bindings
from pathmind.capabilities.ima.tools import BINDINGS_KWARG, IMA_TOOL_NAMES
