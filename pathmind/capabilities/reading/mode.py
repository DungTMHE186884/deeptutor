...
(:class:`pathmind.capabilities.reading.capability.ReadingCapability`), which
...
from pathmind.capabilities.reading.capability import (
    MATERIAL_ID_KEY,
    MODE_KEY,
    resolve_material_id,
)
from pathmind.capabilities.reading.tools import READING_TOOL_NAMES
