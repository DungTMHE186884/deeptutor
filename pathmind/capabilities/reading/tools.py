...
class MaterialOutlineTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.reading import render_outline
...
class SearchMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.reading import search_material
...
class ReadMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.reading import render_units, unit_timestamps
...
class ReaderGotoTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.reading import unit_timestamps, verify_quote
...
class ReaderAnnotateTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.reading import ANNOTATION_COLORS, Annotation, verify_quote
