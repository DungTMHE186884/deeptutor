...
* it fixes the real failure it exists for: weak models under native tool calling
  ...
  :mod:`pathmind.capabilities.explore_context` was built around). Handing the
...
from pathmind.capabilities.reading.tools import (
    BINDING_KWARG,
    MATERIAL_KWARG,
    READING_TOOL_NAMES,
    WORKSPACE_KWARG,
...
class ReadingCapability:
    ...
    def _material_facts(self, material_id: str, *, language: str) -> str:
        ...
        try:
            from pathmind.reading import ReadingStore, material_summary
    ...
    def _locate(material_id: str, question: str) -> list[str]:
        from pathmind.reading import ReadingStore, search_material
