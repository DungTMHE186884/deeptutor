...
:class:`~pathmind.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`pathmind.capabilities.obsidian.vault` operations.
...
from pathmind.capabilities.obsidian import vault as vault_ops
