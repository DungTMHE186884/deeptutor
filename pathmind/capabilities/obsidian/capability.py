...
vault (resolved by :mod:`pathmind.capabilities.obsidian.binding`). As a
...
from pathmind.capabilities.obsidian.binding import obsidian_vault_refs, vault_for_turn
from pathmind.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
from pathmind.capabilities.protocol import KnowledgeCapability, PromptBlock
