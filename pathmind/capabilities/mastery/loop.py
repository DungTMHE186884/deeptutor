...
from pathmind.tools.mastery_nav import MASTERY_NAV_TOOL_NAMES
...
#: Set on the turn by :class:`~pathmind.capabilities.mastery.pipeline.MasteryLoopPipeline`
...
class MasteryLoopCapability:
    ...
    :mod:`pathmind.learning.topic_materials`) are announced every turn as a
