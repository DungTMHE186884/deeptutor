...
(:class:`pathmind.capabilities.solve.loop.SolveLoopCapability`) mounts the
...
from pathmind.capabilities.solve.session import DEFAULT_MAX_REPLANS
from pathmind.capabilities.solve.tools import SOLVE_TOOL_NAMES
from pathmind.core.capability_protocol import (
    CapabilityManifest,
    StreamBusProtocol,
    TurnCapability,
)
...
from pathmind.services.config.capabilities_settings import get_solve_params
