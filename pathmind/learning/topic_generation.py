...
async def _ground_file_source(source: TopicSource) -> TopicSource:
    ...
    try:
        from pathmind.multi_user.knowledge_access import resolve_kb_document_path
        from pathmind.utils.document_extractor import extract_text_from_path_isolated
...
async def ground_topic_sources(
    *,
    ...
    async def ground(source: TopicSource) -> TopicSource:
        from pathmind.services.workspace.knowledge import learning_source_access
