...
import pathmind.learning.migration as migration_module
from pathmind.learning.migration import prepare_mastery_v2_root
from pathmind.learning.models import LearningProgress, MasteryInteraction, PendingQuestion
...
def test_corrupt_live_json_is_quarantined_without_blocking_good_migration(
    ...
    with caplog.at_level(logging.ERROR, logger="pathmind.learning.storage"):
        v2_root = prepare_mastery_v2_root(learning_root)
