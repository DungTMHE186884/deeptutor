...
from pathmind.services.notebook.service import NotebookCorruptedError
from pathmind.video_learning import (
    TimedMediaError,
    TimedMediaNotFound,
...
from pathmind.video_learning import notes as video_notes
...
async def _open_upstream(
    ...
    headers = {"User-Agent": "PathMind/1.0", "Accept": mime}
    if range_header:
