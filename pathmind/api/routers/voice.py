...
These are thin HTTP surfaces over :mod:`pathmind.services.voice`. Config comes
...
from pathmind.services.voice import (
    VoiceProviderError,
    synthesize_speech,
    transcribe_audio,
)
from pathmind.services.voice.audio import _parse_pcm_content_type, _pcm16_to_wav
