...
async def mimic_exam_questions(*args, **kwargs):
    ...
    from pathmind.tools.question import mimic_exam_questions as run
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="pathmind.question.stdout",
...
async def websocket_question_generate(websocket: WebSocket):
    from pathmind.agents.question import AgentCoordinator
    from pathmind.api.routers.auth import ws_auth_failed, ws_require_auth
    from pathmind.multi_user.context import reset_current_user
