...
from pathmind.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints
from pathmind.i18n.metadata_i18n import tool_description_i18n
from pathmind.services.config import resolve_search_runtime_config
...
async def list_builtin_tools() -> ToolsListResponse:
    ...
    from pathmind.capabilities import capability_tool_owners
