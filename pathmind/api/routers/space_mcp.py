...
from pathmind.services.mcp import MCPServerConfig, get_mcp_manager, load_mcp_config, oauth
from pathmind.services.mcp.catalog import (
    build_server_config,
    category_counts,
    get_entry,
    search_catalog,
)
from pathmind.services.mcp.manager import (
    SHARED_OWNER,
    describe_connect_failure,
    probe_server,
)
from pathmind.services.mcp.secrets import configured_fields, delete_secrets, store_secrets
from pathmind.services.mcp.user_config import (
...
def _resolve_for_probe(owner: str, config: MCPServerConfig) -> MCPServerConfig:
    ...
    """
    from pathmind.services.mcp.manager import MCPConnectionManager
...
def _extract_credentials(
    ...
    """
    from pathmind.services.mcp.secrets import SECRET_REFERENCE_RE, secret_reference
