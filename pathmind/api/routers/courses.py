...
from pathmind.services.courses_state import (
...
async def update_course(course_id: str, payload: UpdateCourseRequest) -> dict[str, object]:
    from pathmind.services.courses import COURSE_STATUSES
...
async def update_syllabus_unit(
    ...
    from pathmind.services.courses import SyllabusUnitNotFoundError
