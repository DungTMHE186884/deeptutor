...
from pathmind.i18n.metadata_i18n import localized_description, tool_description_i18n
from pathmind.services.i18n import current_language
...
async def build_tool_options(
    *,
    ...
    from pathmind.runtime.registry.deferred_tools import provider_identity
    from pathmind.runtime.registry.tool_registry import get_tool_registry
    from pathmind.tools.builtin import CONFIGURABLE_BUILTIN_TOOL_NAMES
