...
class BaseChannel(ABC):
    ...
    def media_dir(self, channel: str | None = None) -> Path:
        ...
        from pathmind.partners.config.paths import get_media_dir, get_partner_media_dir
    ...
    def state_dir(self) -> Path:
        ...
        """
        from pathmind.partners.config.paths import get_partner_channel_dir, get_runtime_subdir
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        if not self.transcription_api_key:
            return ""
        try:
            from pathmind.partners.transcription import GroqTranscriptionProvider
