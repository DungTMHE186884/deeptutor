"""The task model — what PathMind runs on when nobody asked it to run.
...
class TaskKind(StrEnum):
    """One call PathMind makes on its own.
...
def task_llm_scope(kind: TaskKind) -> Iterator[LLMConfig | None]:
    ...
    from pathmind.services.llm import config as llm_config_module
