...
from pathmind.core.trace import build_trace_metadata

if TYPE_CHECKING:
    from pathmind.learning.storage import MasteryPathLease
...
class LearningTurnAdapter:
    ...
    async def _grade_submitted_card_answer(
        ...
        *,
        ...
        from pathmind.capabilities.mastery.tools import MasteryGradeTool
    ...
    async def _skip_card_question(
        ...
        *,
        ...
        if not path_id or not question_id:
            return None
        from pathmind.capabilities.mastery.tools import MasterySkipQuestionTool
        from pathmind.learning.service import LearningService
    ...
    async def _acquire_mastery_path_lease(
        ...
        *,
        ...
        from pathmind.learning.storage import LearningStore, PathLeaseConflictError
