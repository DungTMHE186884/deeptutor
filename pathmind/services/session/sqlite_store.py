...
from pathmind.core.assessment import ASSESSMENT_RESULTS, ASSESSMENT_SOURCES, ASSESSMENT_TYPES
from pathmind.services.path_service import get_path_service
from pathmind.services.session.protocol import ActiveTurnConflict
from pathmind.utils.secret_files import ensure_private_directory, ensure_private_file
...
class SQLiteSessionStore:
    ...
    def _initialize(self) -> None:
        with self._connect() as conn:
            ...
            from pathmind.services.practice.storage import initialize_practice
