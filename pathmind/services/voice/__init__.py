...
from pathmind.services.voice.adapters import get_stt_adapter, get_tts_adapter
from pathmind.services.voice.base import (
    TranscriptCue,
    VoiceProviderError,
    strip_markdown_for_speech,
)
from pathmind.services.voice.config import STTConfig, TTSConfig
