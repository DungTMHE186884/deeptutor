...
from pathmind.services.voice.adapters.dashscope import (
    DashScopeSTTAdapter,
    DashScopeTTSAdapter,
)
from pathmind.services.voice.adapters.openai_compat import (
    OpenAICompatSTTAdapter,
    OpenAICompatTTSAdapter,
    OpenRouterTTSAdapter,
)
from pathmind.services.voice.adapters.volcengine import VolcengineSTTAdapter, VolcengineTTSAdapter
from pathmind.services.voice.base import BaseSTTAdapter, BaseTTSAdapter, VoiceProviderError
