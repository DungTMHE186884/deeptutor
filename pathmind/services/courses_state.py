...
async def _book_index() -> ResourceIndex:
    from pathmind.book.engine import get_book_engine
...
async def _notebook_index() -> ResourceIndex:
    from pathmind.services.notebook.service import get_notebook_manager
...
async def _resource_indexes() -> dict[str, ResourceIndex]:
    from pathmind.services.courses import COURSE_RESOURCE_KINDS
...
async def build_course_state(course_id: str) -> dict[str, Any]:
    ...
    from pathmind.services.courses import get_course_service
