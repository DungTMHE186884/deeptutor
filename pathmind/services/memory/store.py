...
from pathmind.services.memory import consolidator, paths, trace
from pathmind.services.memory.consolidator import ConsolidateResult, OnEvent
from pathmind.services.memory.document import Document, parse, serialize
from pathmind.services.memory.ops import AddOp, ApplyReport, EditOp, OpResult
from pathmind.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with PathMind and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from pathmind.services.memory.consolidator import _parse_ops_response
