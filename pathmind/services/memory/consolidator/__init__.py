...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`pathmind.services.memory.store`.
...
from pathmind.services.memory.consolidator.guards import _filter_banned, _has_banned
from pathmind.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from pathmind.services.memory.consolidator.parse import _parse_ops_response
