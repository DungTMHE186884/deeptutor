"""Legacy public-API shims for :mod:`pathmind.services.memory.store`.
...
from pathmind.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from pathmind.services.memory.document import parse, serialize
from pathmind.services.memory.ops import ApplyReport, Op
