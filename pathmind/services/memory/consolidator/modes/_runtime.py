...
from pathmind.services.file_io import atomic_write_text as _atomic_write
...
async def call_llm(
    *,
    ...
    workbench trace.
    """
    from pathmind.services.llm import get_llm_config
...
async def write_doc_checkpoint(
    ...
    *,
    ...
    from pathmind.services.memory.consolidator.runs import push_undo_checkpoint
