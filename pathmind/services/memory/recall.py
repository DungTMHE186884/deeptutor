...
:mod:`pathmind.services.memory.store`.
...
from pathmind.services.memory.paths import SURFACES, Surface
...
def recent(
    *,
    ...
    """
    from pathmind.services.memory.snapshot import adapters
...
def recent_queries(
    *,
    ...
    Tuesday.
    """
    from pathmind.services.memory import trace
