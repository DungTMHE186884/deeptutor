...
from pathmind.services.memory.paths import Surface
from pathmind.services.memory.snapshot.entity import Entity, EntityStamp
...
def read_partner_entities() -> list[Entity]:
    ...
    from pathmind.multi_user.partner_access import assigned_partner_ids
