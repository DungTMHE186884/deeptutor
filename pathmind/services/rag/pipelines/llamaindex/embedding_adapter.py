"""LlamaIndex embedding adapter backed by PathMind's embedding service."""
...
from pathmind.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from pathmind.services.embedding.config import scoped_embedding_config
from pathmind.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for PathMind embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for PathMind's current embedding config."""
