...
document-parse bridge (``pathmind/services/parsing``), so the engine the user
...
from pathmind.services.llm.client import get_llm_client
...
class LlamaIndexDocumentLoader:
    ...
    async def load(
        ...
        for file_path_str in classification.image_files:
            ...
            from pathmind.services.parsing import get_parse_service
    ...
    def _parse_document(
        ...
        """
        from pathmind.services.parsing import ParserError, get_parse_service
