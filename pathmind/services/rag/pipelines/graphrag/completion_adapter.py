...
def _get_adapter_class() -> type:
    ...
    with _CAPABILITY_LOCK:
        ...
        class PathMindLiteLLMCompletion(LiteLLMCompletion):
        ...
        _ADAPTER_CLASS = PathMindLiteLLMCompletion
        return _ADAPTER_CLASS


def register_completion_adapter() -> None:
    """Register PathMind's completion type through GraphRAG's public factory API."""
