"""Resolve PathMind model bindings at the GraphRAG/LiteLLM boundary."""

from __future__ import annotations

from typing import Any

from pathmind.services.llm.reasoning_params import build_openai_compatible_reasoning_kwargs
...
COMPLETION_TYPE = "pathmind_litellm"
...
def resolve_completion_provider(llm_cfg: Any) -> str:
    """Map a resolved PathMind provider to the narrow LiteLLM transport GraphRAG needs."""
    ...
    if backend == "openai_compat":
        ...
        # Other PathMind OpenAI-compatible profiles already expose an OpenAI
...
def resolve_persisted_completion_provider(model_config: Any) -> str:
    """Recover a provider for old PathMind GraphRAG settings without rewriting them."""
