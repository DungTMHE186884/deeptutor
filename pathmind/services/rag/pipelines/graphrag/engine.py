...
used — PathMind runs fine without the optional dependency installed.
"""
...
EMBEDDING_PROBE_TEXT = "PathMind GraphRAG embedding compatibility test"
...
async def _probe_completion_model_impl(llm_cfg: Any) -> None:
    """Probe a resolved PathMind model through the GraphRAG adapter."""
