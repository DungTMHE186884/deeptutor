...
from pathmind.services.provider_registry import find_by_name, strip_provider_prefix
...
def resolve_oss_sdk_config() -> tuple[str, dict[str, Any]]:
    """Translate PathMind's active LLM into PageIndex's indexing lane."""
...
class PageIndexClient:
    """Small async facade used by the PathMind RAG lifecycle."""
