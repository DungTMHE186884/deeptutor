"""Turn-scoped PathMind wrappers for PageIndex Cloud and OSS SDK tools."""
...
from pathmind.core.tool_protocol import BaseTool, ToolDefinition, ToolLookup, ToolResult
...
def pageindex_sources_from_text(
    ...
    *,
    ...
    """Normalize real PageIndex page reads into PathMind source rows."""
    try:
