"""Freeze PathMind parse results into version-local LightRAG ingress bundles."""
...
from pathmind.services.parsing.types import ParsedDocument

from . import block_policy

PARSER_BRIDGE_SCHEMA = 1
INGRESS_DIRNAME = "pathmind_ingress"
