"""LightRAG parser that consumes frozen PathMind ingress bundles."""
...
class PathMindParser(BaseParser):
    """Third-party parser registered as ``pathmind`` in LightRAG rc2."""

    engine_name = "pathmind"
