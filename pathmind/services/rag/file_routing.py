...
class FileTypeRouter:
    ...
    def get_parser_extensions(cls) -> set[str]:
        ...
        """
        from pathmind.services.parsing.engines.formats import known_parser_formats
    ...
    def active_parser_accepts_any_format(cls) -> bool:
        ...
        try:
            from pathmind.services.parsing.engines.factory import get_parser
            from pathmind.services.parsing.service import get_parse_service
