...
Unified LLM service for all PathMind modules.
...
Usage:
    ...
    from pathmind.services.llm import complete, stream
    ...
    # Configuration
    from pathmind.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from pathmind.services.llm import sanitize_url, is_local_llm_server
"""
...
def __getattr__(name: str):
    ...
    if name == "cloud_provider":
        return import_module("pathmind.services.llm.cloud_provider")
    if name == "local_provider":
        return import_module("pathmind.services.llm.local_provider")
