...
if TYPE_CHECKING:
    from pathmind.services.provider_registry import ProviderSpec
...
OPENROUTER_ATTRIBUTION_HEADERS: dict[str, str] = {
    "HTTP-Referer": "https://pathmind.local",
    "X-OpenRouter-Title": "PathMind",
}
...
def openai_sdk_client_kwargs(
    *,
    ...
    The one place that decides what every OpenAI-SDK client PathMind builds
