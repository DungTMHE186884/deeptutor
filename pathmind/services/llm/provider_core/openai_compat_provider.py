...
from pathmind.services.keypool import KeyPool
from pathmind.services.llm.capabilities import (
    disable_forced_tool_choice_at_runtime,
    disable_response_format_at_runtime,
    is_forced_tool_choice_disabled_at_runtime,
)
from pathmind.services.llm.exceptions import LLMConfigError
from pathmind.services.llm.openai_http_client import openai_sdk_client_kwargs
...
from pathmind.services.provider_registry import model_overrides_for, normalize_wire_api
    ...
    def _sanitize_messages(
        ...
        *,
        ...
        if responses_api:
            ...
            # a protocol identity. The converter splits PathMind's compound
