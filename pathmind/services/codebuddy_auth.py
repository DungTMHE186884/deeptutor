...
class CodeBuddyAuthService:
    ...
    async def logout(self) -> dict[str, Any]:
        """Disconnect PathMind from the CodeBuddy session on this host.
        ...
        # PathMind does not own this credential: it is the session the IDE
        ...
        from pathmind.runtime.agentic.client import reset_agentic_client_pool
        from pathmind.services.codebuddy_credentials import load_credentials
    ...
    async def _probe_local_login(self) -> bool:
        ...
        """
        from pathmind.services.codebuddy_credentials import load_credentials, probe_account
