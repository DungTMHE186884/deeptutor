...
from pathmind.core.tool_protocol import BaseTool, ToolDefinition, ToolResult
from pathmind.runtime.providers.text import sanitize_provider_document, sanitize_provider_text
from pathmind.services.cli_apps.catalog import get_entry
from pathmind.services.cli_apps.models import TOOL_PREFIX
from pathmind.services.cli_apps.paths import runtime_dir
from pathmind.services.cli_apps.runner import (
    DEFAULT_TIMEOUT_S,
    MAX_OUTPUT_CHARS,
    MAX_TIMEOUT_S,
    run_app,
)
from pathmind.services.cli_apps.state import InstalledApp, disabled_apps, load_installed
from pathmind.services.i18n import t
from pathmind.services.sandbox.spec import ExecResult
...
class CliAppTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        if workdir:
            from pathmind.services.sandbox.artifacts import snapshot_public_artifact_files
        ...
        from pathmind.services.workspace.execution import logicalize_workspace_text
        ...
        if workdir:
            ...
            from pathmind.services.sandbox.artifacts import (
