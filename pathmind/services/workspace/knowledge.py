...
def resolve_qualified(kb_ref: str, *, require_write=False):
    from pathmind.multi_user.knowledge_access import _resolve_kb
...
def knowledge_catalog() -> list[dict]:
    from pathmind.multi_user.knowledge_access import _list_visible_knowledge_bases
...
def resolve_selected(kb_ref: str, selected: list[str], *, require_write=False):
    from pathmind.multi_user.knowledge_access import DEFAULT_KB_ALIASES, _strip_resource_prefix
