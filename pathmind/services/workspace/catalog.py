...
from pathmind.services.workspace.models import WorkspaceBinding, WorkspaceError
...
class WorkspaceCatalogMixin:
    ...
    def _write_system_snapshot(self, root: Path) -> dict[str, Any]:
        ...
        from pathmind.services.workspace.snapshot import write_snapshot
    ...
    def create_workspace(
        ...
        if resources is not None:
            from pathmind.services.workspace.resources import validate_resources
    ...
    def migrate_workspace(self, workspace_id: str, destination: str) -> dict[str, Any]:
        from pathmind.services.workspace.migration import migrate_locations
