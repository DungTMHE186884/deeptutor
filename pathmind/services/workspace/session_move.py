...
from pathmind.services.workspace.context import current_workspace_id, workspace_context
from pathmind.services.workspace.data_migration import (
    _journal_root,
    _sessions,
    migrate_data,
    preview,
...
def move_chat(session_id: str, target_id: str) -> dict:
    ...
    with workspace_context(target_id):
        from pathmind.services.workspace.data_migration import _backend
