...
Unified configuration loading for all PathMind modules.
...
def parse_language(language: Any) -> str:
    ...
    from pathmind.services.prompt.language import normalize_language
...
def get_agent_params(module_name: str) -> dict:
    ...
    from pathmind.services.setup.init import DEFAULT_AGENTS_SETTINGS
