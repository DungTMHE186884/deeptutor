...
from pathmind.knowledge.add_documents import DEFAULT_BASE_DIR
from pathmind.services.web_source.crawler import _contained_path, crawl_and_diff
...
def _url_to_filename(url: str, base_path_prefix: str) -> str:
    ...
    from pathmind.services.web_source.crawler import _to_filename
    ...
    *,
    ...
    for fname in diff.pages_removed:
        ...
        if target is None:
            ...
            continue
        try:
            from pathmind.knowledge.add_documents import remove_raw_document
    ...
    try:
        if diff.pages_removed:
            ...
            from pathmind.knowledge.add_documents import add_documents
...
from pathmind.services.web_source.navigation import (  # noqa: F401, E402
    build_navigation_manifest as _build_navigation_manifest_impl,
)
from pathmind.services.web_source.navigation import (
