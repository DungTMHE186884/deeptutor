...
from pathmind.runtime.home import PACKAGE_ROOT, get_runtime_data_root
from pathmind.utils.secret_files import ensure_private_directory, write_secret_text
...
class PathService:
    ...
    def get_parse_cache_root(self) -> Path:
        ...
        ``(source_hash, parser_signature)`` — see ``pathmind/services/parsing``.
        """
