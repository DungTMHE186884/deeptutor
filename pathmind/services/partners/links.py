"""Linking a chat-channel account to a PathMind account.

A partner reached over QQ or Telegram knows only a channel-local sender id.
Nothing connects that to the person's PathMind account, so without a link
...
from pathmind.partners.config.paths import get_partner_dir
