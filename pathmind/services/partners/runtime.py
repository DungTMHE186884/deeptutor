...
from pathmind.multi_user.paths import get_path_service_for_scope
...
from pathmind.partners.helpers import detect_image_mime
from pathmind.services.partners.commands import PartnerCommandHandler
from pathmind.services.partners.interaction import (
    actor_for_account,
...
from pathmind.services.partners.links import linked_user_id
from pathmind.services.partners.scope import partner_scope
from pathmind.services.partners.sessions import PartnerSessionStore, conversation_scope
from pathmind.services.partners.workspace import ensure_partner_workspace, read_soul
from pathmind.services.partners.workspace_binding import partner_content_context
...
class PartnerRunner:
    ...
    def _identify(self, msg: InboundMessage) -> None:
        """Attach the sender's PathMind identity to a channel message, if any.
    ...
    async def _execute_turn(
        ...
        *,
        ...
        """
        from pathmind.runtime.turn_engine import get_turn_engine
    ...
    def _build_context(
        ...
        *,
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are PathMind")
        ...
        from pathmind.core.context import TurnRuntimeContext
    ...
    def _list_kb_names(self) -> list[str]:
        if getattr(self.config, "workspace_id", ""):
            from pathmind.knowledge.kb_types import supports_rag_retrieval
