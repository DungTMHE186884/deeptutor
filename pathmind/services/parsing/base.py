...
stage. An engine turns bytes/path into a :class:`~pathmind.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`pathmind.services.parsing.cache.load_ir` and writes
