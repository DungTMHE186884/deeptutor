...
from pathmind.runtime.isolated_worker import IsolatedWorkerError, run_in_isolated_process_sync
        ...
        *,
        ...
        try:
            run_in_isolated_process_sync(
                "pathmind.runtime.worker_tasks:extract_document_to_markdown",
                str(source_path),
                str(output_path),
                kwargs={
