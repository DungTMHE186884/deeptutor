...
The fallback mirrors Docling 2.123.1, the minimum version PathMind installs.
...
def docling_supported_formats() -> frozenset[str]:
    """Return the formats supported by PathMind's Docling compatibility floor.
...
def docling_version_is_current(version: str | None = None) -> bool:
    """Whether ``version`` satisfies PathMind's Docling compatibility floor."""
