...
Each engine implements the :class:`~pathmind.services.parsing.base.Parser`
contract and is selected by name through :mod:`pathmind.services.parsing.engines.factory`.
