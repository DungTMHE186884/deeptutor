...
:class:`~pathmind.services.mcp.config.MCPServerConfig`, the only server shape
the rest of PathMind understands.
...
:mod:`pathmind.services.mcp.secrets` resolves in memory at connect time. That
...
from pathmind.services.mcp.config import MCPServerConfig
from pathmind.services.mcp.secrets import secret_reference
