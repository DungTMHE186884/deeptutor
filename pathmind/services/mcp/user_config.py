...
(:mod:`pathmind.services.mcp.config`). This module is the parallel store for
...
:mod:`pathmind.services.mcp.secrets` mean anything.
...
from pathmind.services.mcp.config import MCPConfig, MCPServerConfig
from pathmind.services.mcp.network import validate_mcp_url
