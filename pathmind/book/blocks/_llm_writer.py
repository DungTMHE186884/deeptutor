...
``pathmind.services.llm.complete`` directly with a sane default config.
"""
...
from pathmind.services.llm.structured_retry import json_payload_is_usable
...
async def llm_json(
    *,
    ...
    :func:`pathmind.services.llm.structured_retry.json_with_reasoning_retry`.
