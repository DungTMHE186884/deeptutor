...
Wraps :class:`pathmind.agents.visualize.pipeline.VisualizePipeline` with
...
class FigureGenerator(BlockGenerator):
    ...
    async def _generate(
        ...
        try:
            from pathmind.agents.visualize.models import ReviewResult
            from pathmind.agents.visualize.pipeline import VisualizePipeline
            from pathmind.agents.visualize.utils import validate_visualization
