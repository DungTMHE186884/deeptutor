...
Reuses:
- ``pathmind.services.session.get_sqlite_session_store`` for chat history
- ``pathmind.services.notebook.notebook_manager`` for notebook records
- ``pathmind.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
...
async def build_book_inputs(
    *,
    ...
    if source_refs:
        ...
        from pathmind.learning.topic_generation import ground_topic_sources
        from pathmind.learning.topic_materials import build_topic_materials
