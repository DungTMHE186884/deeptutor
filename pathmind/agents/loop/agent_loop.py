...
from pathmind.agents.loop.ask_user_drafts import AskUserDraftEmitter
from pathmind.agents.loop.context_budget import LLMRequestSnapshot
from pathmind.agents.loop.dsml_tool_calls import DSMLStreamFilter, extract_dsml_tool_calls
from pathmind.core.context import UnifiedContext
from pathmind.core.trace import build_trace_metadata, merge_trace_metadata, new_call_id
from pathmind.runtime.agentic.messages import assistant_message_with_tool_calls
from pathmind.runtime.agentic.think_stream import InlineThinkFilter
from pathmind.runtime.agentic.tool_call_stream import ToolCallAccumulator
from pathmind.runtime.agentic.tool_dispatch import DispatchOutcome
from pathmind.runtime.agentic.usage import message_content_chars, record_streamed_usage
...
from pathmind.services.llm.capabilities import threads_session_id
from pathmind.services.llm.multimodal import should_degrade_to_text, strip_image_parts_inplace
from pathmind.services.llm.request_compat import (
...
from pathmind.services.llm.usage_frame import usage_breakdown
from pathmind.services.llm.utils import unreachable_endpoint_hint
    ...
    async def run(self) -> dict[str, Any]:
        ...
        async with self.stream.stage(self.stage, source=self.source):
            ...
            try:
                ...
                from pathmind.services.session.model_history import (
    ...
    async def _call_llm(
        ...
        *,
        ...
        if threads_session_id(self.pipeline.binding):
            kwargs["pathmind_session_id"] = self.context.session_id
        ...
        from pathmind.services.llm.request_cache import compare_requests, fingerprint_request
