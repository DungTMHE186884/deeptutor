...
Chat's foundation is "you are PathMind, here is the exploring-loop protocol".
...
from pathmind.runtime.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
...
class LoopPromptAssembler:
    ...
    def foundation_blocks(self, context: UnifiedContext) -> list[PromptBlock]:
        ...
        difference between "you are a tutor" and "you are PathMind, but in
    ...
    def _general_block(self, context: UnifiedContext) -> str:
        ...
        the "You are PathMind" general is swapped for ``general_partner``.
