...
from pathmind.agents._shared.capability_result import emit_capability_result
...
from pathmind.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from pathmind.agents.research.utils.citation_manager import CitationManager
from pathmind.core.context import Attachment, UnifiedContext
...
from pathmind.runtime.agentic.messages import assistant_message
...
from pathmind.services.config import parse_language
from pathmind.services.config.loader import get_capability_params
from pathmind.services.llm import get_llm_config, prepare_multimodal_messages
from pathmind.services.llm.structured_retry import payload_with_reasoning_retry
from pathmind.services.prompt import get_prompt_manager
from pathmind.services.prompt.language import append_language_directive
from pathmind.services.sandbox import exec_capability_available
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`pathmind.runtime.agentic` primitives. The
    ...
    def __init__(
        ...
        *,
        ...
        if self.kb_name:
            try:
                from pathmind.knowledge.kb_types import OBSIDIAN_KB_TYPE
                from pathmind.multi_user.knowledge_access import resolve_kb_metadata
    ...
    async def _prepare_pageindex_tools(self) -> None:
        from pathmind.services.rag.pipelines.pageindex.tools import (
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from pathmind.agents.chat.agentic_pipeline import (
