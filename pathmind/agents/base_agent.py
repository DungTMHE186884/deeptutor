...
from pathmind.config.settings import settings
from pathmind.logging import LLMStats
from pathmind.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"pathmind.{logger_name}")
