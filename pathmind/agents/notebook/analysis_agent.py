...
from pathmind.agents.notebook._text import clip_text as _clip_text
from pathmind.core.stream import StreamEvent, StreamEventType
from pathmind.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
...
from pathmind.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from pathmind/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
