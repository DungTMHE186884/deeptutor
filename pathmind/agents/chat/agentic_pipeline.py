...
:mod:`pathmind.agents.chat.prompts` are all the defaults declared on
:class:`~pathmind.agents.loop.pipeline.AgenticLoopPipeline`.
...
tests and read by :mod:`pathmind.agents.chat.capability`.
"""

from __future__ import annotations

from pathmind.agents.loop.pipeline import (
