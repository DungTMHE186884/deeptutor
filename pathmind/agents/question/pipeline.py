...
to :mod:`pathmind.runtime.agentic` and the shared tool-composition policy.
"""
...
from pathmind.runtime.agentic.labels import find_inline_labels
...
from pathmind.runtime.agentic.usage import record_streamed_usage
...
from pathmind.services.llm.reasoning_params import RETRY_REASONING_EFFORT
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="PathMind Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="PathMind Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
