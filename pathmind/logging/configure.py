...
_CONFIGURED = False
_MANAGED_ATTR = "_pathmind_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    if config.file_output:
        ...
        log_path = log_dir / "pathmind.jsonl"
    ...
    logging.getLogger("pathmind").setLevel(logging.DEBUG)
    logging.getLogger("pathmind").propagate = True
