"""Neutral plugin discovery for PathMind.

External packages register under the ``pathmind.plugins`` entry-point group.
...
ENTRY_POINT_GROUP = "pathmind.plugins"
...
def discover_plugins() -> list[PluginManifest]:
    """Discover plugins registered via ``pathmind.plugins`` entry points."""
