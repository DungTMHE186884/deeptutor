...
from pathmind.reading.catalog_models import (
    IngestionStatus,
    MaterialRecord,
    SourceKind,
)
from pathmind.reading.catalog_store import ReadingCatalogStore
from pathmind.reading.extract import split_markdown_by_headings
from pathmind.reading.models import OutlineEntry, ReadingError, UnitReference
from pathmind.reading.store import ReadingStore, content_hash
from pathmind.services.web_source.markdown import strip_leading_snapshot_provenance
from pathmind.services.web_source.snapshot_assets import (
    ImageFetcher,
    localize_snapshot_images,
)
from pathmind.services.workspace.activity import workspace_writer
from pathmind.tools.web_fetch import FetchOutcome, fetch_url_as_markdown
    ...
    def __init__(
        ...
        *,
        ...
        if transcriber is None:
            from pathmind.services.voice import transcribe_audio_cues
...
async def _load_bilibili_media(url: str, languages: Sequence[str]) -> BilibiliMedia:
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 PathMind/ImmersiveReading",
    }
...
def media_cover_url(material_id: str) -> str:
    ...
    from pathmind.services.workspace.context import workspace_url
