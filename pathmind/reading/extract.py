...
from pathmind.reading.models import OutlineEntry, ReadingError, RenderMode, UnitKind, UnitReference
...
def _extract_epub(source: Path) -> Extraction:
    ...
    from pathmind.utils.document_extractor import DocumentExtractionError, extract_epub_spine
