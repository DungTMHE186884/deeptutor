...
chat loop or the LLM; it takes a :class:`~pathmind.reading.store.ReadingStore`
...
from pathmind.reading.models import MaterialManifest, OutlineEntry, ReadingError
from pathmind.reading.search import SearchResult, locate_quote, search_units
from pathmind.reading.store import MAX_READ_CHARS, ReadingStore
...
def render_units(
    ...
    *,
    ...
    (``--- Page 12 ---``), so a model that has seen a PathMind attachment
