...
Pairing is deliberately two-step: PathMind recommends likely language
...
from pathmind.reading.models import MaterialManifest, ReadingError
from pathmind.services.file_io import atomic_write_text as _atomic_write

if TYPE_CHECKING:
    from pathmind.reading.store import ReadingStore
