"""Detached executor for a launcher-managed PathMind update."""
...
from pathmind.services.app_update import UpdateJob, UpdateJobStore
...
def build_restart_command(job: UpdateJob) -> tuple[list[str], Path]:
    ...
    return [sys.executable, "-m", "pathmind_cli.main", *job.restart_argv], home
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply a managed PathMind update")
