...
from pathmind.core.capability_protocol import TurnCapability
from pathmind.core.entry_points import load_entry_point_group
from pathmind.i18n.metadata_i18n import capability_description_i18n
from pathmind.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_SPECS
from pathmind.runtime.capability_catalog import (
    CapabilityCatalog,
    EmptyConfig,
    get_capability_catalog,
)
from pathmind.runtime.request_contracts import CAPABILITY_CONFIG_MODELS

logger = logging.getLogger(__name__)

EXTENSIONS_GROUP = "pathmind.extensions"
LEGACY_PLUGINS_GROUP = "pathmind.plugins"
...
class CapabilityRegistry:
    ...
    def load_plugins(self) -> None:
        ...
        try:
            module = importlib.import_module("pathmind.plugins.loader")
