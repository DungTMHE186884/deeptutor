...
Two things the process-global :class:`~pathmind.runtime.registry.tool_registry.ToolRegistry`
...
from pathmind.tools.prompting import compose_prompt_text
...
class ScopedToolRegistry:
    ...
    Satisfies :class:`~pathmind.core.tool_protocol.ToolLookup`. Intentionally
