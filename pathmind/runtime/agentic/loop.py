...
:func:`~pathmind.runtime.agentic.labeled_step.run_labeled_step` call, after
which the loop:
...
from pathmind.runtime.agentic.labeled_step import LabeledStepResult, run_labeled_step
from pathmind.runtime.agentic.labels import LABEL_UNKNOWN, find_inline_labels
from pathmind.runtime.agentic.messages import (
    assistant_message,
