...
from pathmind.services.llm.usage_frame import token_counts
...
class UsageTracker:
    ...
    * :meth:`add_estimated` — fall back to a coarse ``chars / 3.5`` estimate
    ...
    ``total_cost_usd`` via the pricing table in ``pathmind.logging.stats``.
    """
    ...
    def add_usage(
        ...
        *,
        ...
        """Adapter for :class:`~pathmind.agents.base_agent.BaseAgent`.
    ...
    def summary(self) -> dict[str, Any] | None:
        ...
        if self.model:
            ...
            from pathmind.logging.stats.llm_stats import get_pricing
