...
from pathmind.core.tool_protocol import ToolLookup, provider_identity
...
from pathmind.runtime.agentic.tool_arg_guard import (
...
async def _reject_if_args_missing(
    *,
    ...
    fill in. See :mod:`pathmind.runtime.agentic.tool_arg_guard` for why the
