...
from pathmind.core.capability_protocol import CapabilityManifest
...
BUILTIN_CAPABILITY_CLASSES: dict[str, str] = {
    "chat": "pathmind.agents.chat.capability:ChatCapability",
    "ask_questions": ("pathmind.capabilities.ask_questions.capability:AskQuestionsCapability"),
    "deep_solve": "pathmind.capabilities.solve.capability:DeepSolveCapability",
    "deep_question": "pathmind.agents.question.capability:DeepQuestionCapability",
    "deep_research": "pathmind.agents.research.capability:DeepResearchCapability",
    "math_animator": "pathmind.agents.math_animator.capability:MathAnimatorCapability",
    "visualize": "pathmind.agents.visualize.capability:VisualizeCapability",
    "mastery_path": "pathmind.capabilities.mastery.capability:MasteryPathCapability",
    "immersive_reading": "pathmind.capabilities.reading.mode:ImmersiveReadingCapability",
    "course_study": "pathmind.capabilities.course_study.mode:CourseStudyCapability",
    "immersive_watching": "pathmind.capabilities.watching.mode:ImmersiveWatchingCapability",
}
