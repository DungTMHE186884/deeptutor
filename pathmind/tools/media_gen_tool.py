...
if TYPE_CHECKING:
    from pathmind.services.sandbox.artifacts import SandboxArtifact
...
def _write_media(
    ...
    *,
    ...
    from pathmind.services.sandbox.artifacts import collect_public_artifacts
...
def _artifact_result(
    ...
    from pathmind.services.sandbox.artifacts import render_artifacts_for_tool
...
class ImagegenTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.services.imagegen import GenerationProviderError, generate_image
...
class VideogenTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.services.videogen import GenerationProviderError, generate_video
