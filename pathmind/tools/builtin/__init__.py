...
from pathmind.core.tool_protocol import BaseTool, ToolDefinition, ToolParameter, ToolResult
from pathmind.knowledge.manifest import KB_FILES_DEFAULT_LIMIT, KB_FILES_MAX_LIMIT
from pathmind.tools.builtin_specs import (
    BUILTIN_TOOL_NAMES,
    BUILTIN_TOOL_SPECS,
...
from pathmind.tools.prompting import load_prompt_hints
from pathmind.tools.question_bank import ACTIONS as QB_ACTIONS
from pathmind.tools.question_bank import FILTERS as QB_FILTERS
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.brainstorm import brainstorm
...
class RAGTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.rag_tool import rag_search
...
class KbFilesTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.knowledge.manifest import render_manifest_report
...
class KnowledgeFrontierTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.multi_user.knowledge_access import resolve_kb_manifest
        from pathmind.tools.knowledge_frontier import discover_frontier
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.web_search import web_search
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.paper_search_tool import ArxivSearchTool
...
class GeoGebraAnalysisTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.agents.vision_solver.vision_solver_agent import VisionSolverAgent
        from pathmind.services.llm.config import get_llm_config
...
class ReadMemoryTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.services.memory import get_memory_store
...
class WriteMemoryTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.services.memory import get_memory_store
        from pathmind.services.memory.trace import TraceEvent
...
class WebFetchTool(_PromptHintsMixin, BaseTool):
    ...
    ``pathmind.tools.web_fetch`` so this wrapper stays free of network
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.web_fetch import (
            DEFAULT_MAX_CHARS,
...
class ListNotebookTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.list_notebook import list_notebooks_or_records
...
class QuestionBankTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.question_bank import run_question_bank
...
class WriteNoteTool(_PromptHintsMixin, BaseTool):
    ...
    * ``edit`` — patch an existing record's title / body / summary.
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.write_note import write_note
...
class GithubTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.github_query import run_github_query
...
class AskUserTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.ask_user import build_ask_user_payload
...
class ReadSkillTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        from pathmind.services.skill.runtime import runtime_skills
...
class CronTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from pathmind.tools.cron_tool import run_cron_action
...
_LAZY_CLASS_EXPORTS = {
    "ExecTool": "pathmind.tools.exec_tool:ExecTool",
    "ImagegenTool": "pathmind.tools.media_gen_tool:ImagegenTool",
    "VideogenTool": "pathmind.tools.media_gen_tool:VideogenTool",
    "PartnerReadTool": "pathmind.tools.partner_memory:PartnerReadTool",
    "PartnerMemorizeTool": "pathmind.tools.partner_memory:PartnerMemorizeTool",
    "PartnerSearchTool": "pathmind.tools.partner_memory:PartnerSearchTool",
    "SubmitVisualizationTool": "pathmind.visualizers.tool:SubmitVisualizationTool",
}
