"""The single sandboxed execution tool exposed to PathMind agents."""
...
class ExecTool(BaseTool):
    ...
    def _limits(raw_timeout: Any):
        from pathmind.services.sandbox import ResourceLimits
    ...
    async def _execute_shell(self, *, code: str, kwargs: dict[str, Any]) -> ToolResult:
        ...
        from pathmind.services.sandbox import ExecRequest, get_sandbox_service
    ...
    async def _execute_source(
        ...
        *,
        ...
        from pathmind.services.sandbox import ExecRequest, Mount, get_sandbox_service
        from pathmind.services.sandbox.artifacts import snapshot_public_artifact_files
        ...
        if source_root_raw:
            ...
            call_relative = (
                Path(".pathmind") / "exec_calls" / (f"{language}_{uuid.uuid4().hex[:12]}")
            )
        ...
        from pathmind.services.workspace.execution import logical_workspace_path
