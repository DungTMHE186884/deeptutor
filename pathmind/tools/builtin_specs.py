"""Import-cheap catalog for PathMind's built-in tools.
...
from pathmind.core.tool_protocol import BaseTool
...
BUILTIN_TOOL_SPECS: tuple[BuiltinToolSpec, ...] = (
    *_specs(
    ...
    BuiltinToolSpec("exec", "pathmind.tools.exec_tool:ExecTool"),
    *_specs(
        "pathmind.tools.workspace",
        (
    ...
    BuiltinToolSpec("submit_visualization", "pathmind.visualizers.tool:SubmitVisualizationTool"),
    BuiltinToolSpec("imagegen", "pathmind.tools.media_gen_tool:ImagegenTool"),
    BuiltinToolSpec("videogen", "pathmind.tools.media_gen_tool:VideogenTool"),
    *_specs(
        "pathmind.tools.mastery_nav",
        (
    ...
    *_specs(
        "pathmind.capabilities.mastery.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.solve.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.obsidian.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.marginnote4.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.ima.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.reading.tools",
        (
    ...
    *_specs(
        "pathmind.capabilities.setup.tools",
        (
    ...
    BuiltinToolSpec(
        "propose_partner", "pathmind.capabilities.partner_authoring.tools:ProposePartnerTool"
    ),
    BuiltinToolSpec("invoke_other", "pathmind.capabilities.partner_group.tools:InvokeOtherTool"),
    *_specs(
        "pathmind.capabilities.course_study.tools",
        (
