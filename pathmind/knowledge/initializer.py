...
if TYPE_CHECKING:
    ...
    from pathmind.services.rag.pipelines.lightrag.indexing_policy import IndexingLLMSnapshot
...
from pathmind.services.rag.factory import normalize_provider_name
...
class KnowledgeBaseInitializer:
    ...
    async def display_statistics_generic(self) -> None:
        ...
        from pathmind.services.rag.index_probe import inspect_kb_versions
