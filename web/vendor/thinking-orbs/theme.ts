...
/**
 * PathMind local addition: parse a computed CSS colour into a paintable
...
/**
 * PathMind local addition: the host element's live `currentColor`, as a raw
 ...
 * class/`data-theme` mutations `useResolvedDark` watches: two of PathMind's
